...
##' @param url jpg image to classify
##' @param numclust number of clusters, with 1 as default
##' @return Side by side plot of original image and k clustered image
##' @author Ellis Wong
##' @export
##' @examples
##' imageClassifier(url = 'https://res.cloudinary.com/twenty20/private_images/t_low-crop/photosp/f985a04a-3f6a-4407-b3d8-722aac5eb6d8/f985a04a-3f6a-4407-b3d8-722aac5eb6d8.jpg', numclust = 4)
